...
public class Chat {
	...
	/**
	 * Funkcija, ki vzame ime uporabnika in vrne seznam vseh prijavljenih
	 * uporabnikov.
	 */
	public static List<User> get_users(String name) {
		ObjectMapper mapper = new ObjectMapper(); // z mapperjem pretvarjamo iz
													// in v Json.
	...
	/**
	 * Funkcija, ki ji podamo ime s katerim se želimo vpisati in nam vrne true,
	 * èe nas je uspela vpisati in false, èe nas ni.
	 */
	...
	/**
	 * Funkcija izpiše uporabnika katerega ime podamo za parameter. Èe
	 * izpisujemo uporabnika, ki ni vpisan javi napako.
	 */
	...
	/**
	 * Funkcija vzame dva parametra: ime uporabnika (ki mora biti prijavljen) in
	 * vsebino sporoèila. Sporoèilo pošlje vsem trenutnim uporabnikom.
	 */
	public static void send(String me, String myMessage) {
		URI uri;
		try {
			uri = new URIBuilder("http://chitchat.andrej.com/messages").addParameter("username", me).build();
	...
	/**
	 * Funkcija vzame tri parametre: ime uporabnika, ki pošilja sporoèilo (ki
	 * mora biti prijavljen), ime uporabnika, ki bo sporoèilo prejel in vsebino
	 * sporoèila in pošle sporoèilo.
	 */
	...
	/**
	 * Funkcija vzame za parameter ime vpisanega uporabnika in izpiše vsa
	 * sporoèila, ki jih je ta uporabnik prejel od zadnjega klica te funkcije
	 * (oz. od vpisa v klepetalnik).
	 */
